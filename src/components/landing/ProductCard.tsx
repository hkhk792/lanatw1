...
const ProductCard = ({ image, name, flavor, price, index }: Props) => {
  ...
  return (
    <div
      ref={ref}
      className="reveal group relative aspect-[4/5] overflow-hidden bg-gradient-card hairline border cursor-pointer"
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-t from-obsidian via-obsidian/20 to-transparent opacity-80 group-hover:opacity-95 transition-opacity duration-700" />
      </div>
      ...
      <div className="absolute inset-x-4 bottom-4 z-10 glass p-5 translate-y-4 opacity-90 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-700 ease-luxury">
        <div className="flex items-end justify-between gap-4">
          <div className="min-w-0">
            <h3 className="font-serif text-xl text-foreground truncate">{name}</h3>
