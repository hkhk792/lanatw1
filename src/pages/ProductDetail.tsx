...
const productMain = productPhoto("product-12.webp");
const productThumb1 = productPhoto("product-13.webp");
const productThumb2 = productPhoto("product-11.webp");
const logoImage = SITE_LOGO_PHOTO;
const doraemonMain = productPhoto("wps1.webp");
const doraemonThumb1 = productPhoto("wps3.webp");
const doraemonThumb2 = productPhoto("wps2.webp");
const luffyMain = productPhoto("16.webp");
const luffyThumb1 = productPhoto("18.webp");
const luffyThumb2 = productPhoto("17.webp");
const kakashiMain = productPhoto("kakashi-main.webp");
const kakashiThumb1 = productPhoto("kakashi-thumb-1.webp");
const kakashiThumb2 = productPhoto("kakashi-thumb-2.webp");
const ktMain = productPhoto("kt-main.webp");
const ktThumb1 = productPhoto("kt-thumb-1.webp");
const ktThumb2 = productPhoto("kt-thumb-2.webp");
const kuromiMain = productPhoto("kuromi-main.webp");
const kuromiThumb1 = productPhoto("kuromi-thumb-1.webp");
const kuromiThumb2 = productPhoto("kuromi-thumb-2.webp");
const zoroGreenMain = productPhoto("zoro-green-main.webp");
const zoroGreenThumb1 = productPhoto("zoro-green-thumb-1.webp");
const zoroGreenThumb2 = productPhoto("zoro-green-thumb-2.webp");
